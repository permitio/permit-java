...
public class PDP {
  ...
  public PDP BACKEND_SERVICE_URL(String BACKEND_SERVICE_URL) {
  ...
  **/
  ...
  public PDP OPA_DECISION_LOG_INGRESS_ROUTE(String OPA_DECISION_LOG_INGRESS_ROUTE) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PDP pdp = (PDP) o;
    return Objects.equals(this.BACKEND_SERVICE_URL, pdp.BACKEND_SERVICE_URL) &&
        Objects.equals(this.OPA_DECISION_LOG_INGRESS_ROUTE, pdp.OPA_DECISION_LOG_INGRESS_ROUTE);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PDP
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PDP.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in PDP is not found in the empty JSON string", PDP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PDP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PDP` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PDP.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PDP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PDP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PDP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PDP.class));

       return (TypeAdapter<T>) new TypeAdapter<PDP>() {
           @Override
           public void write(JsonWriter out, PDP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PDP read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PDP given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PDP
  * @throws IOException if the JSON string is invalid with respect to PDP
  */
  public static PDP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PDP.class);
  }

 /**
  * Convert an instance of PDP to an JSON string
  *
  * @return JSON string
  */
